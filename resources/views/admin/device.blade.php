            ...
            <div class="modal-body">
                <form method="post" id="frm" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtDescription" name="Description" maxlength="200" placeholder="Device Name" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtKeyWord" class="col-sm-3 col-form-label">Device KeyWord</label>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtKeyWord" name="KeyWord" maxlength="200" placeholder="Device Name" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtStatus" class="col-sm-3 col-form-label">Device Status</label>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtStatus" name="Status" maxlength="200" placeholder="Device Name" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtDetail" class="col-sm-3 col-form-label">Device Serial Number</label>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtSerialNumber" name="SerialNumber" maxlength="200" placeholder="Device Name" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtDetail" class="col-sm-3 col-form-label">Device Detail</label>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtDetail" name="Detail" maxlength="200" placeholder="Device Name" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtGuaranteeStart" class="col-sm-3 col-form-label">Device Guarantee Start</label>
                        <div class="col-sm">
                            <input type="date" class="form-control" id="txtGuaranteeStart" name="GuaranteeStart" maxlength="200" placeholder="Device Name" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
        ...
        var tbl = $('#tbl').DataTable({
            ...
            columns: [
                ...
                { data: null,  render: function ( data, type, row ) {
                    return '<img class="img-fluid" src="' + base_url + '/public/data/devices/' + data.Img + '"/>';
                }},
                { data: 'DisplayOrder' },
                { data: null,  render: function ( data, type, row ) {
...
//         ----------- end: select2 ------------
        ...
        $('#editModal').modal({ show: false }).on('show.bs.modal', function (e) {
            ...
            if (infoData != null) {
                ...
                $('#txtTYPE_ID').val(infoData.TYPE_ID);
