...
<div class="card-body">
    <table id="tbl" class="table table-bordered table-hover table-striped">
        <thead>
            ...
            <th style="width: 150px;">Borrower Group</th>
            <th>Full Name</th>
            <th>Phone</th>
            <th>Email</th>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" id="frm" enctype="multipart/form-data">
                ...
                <div class=" form-row">
                    <label for="drpBOGROUP_ID" class="col-sm-3 col-form-label">Borrower Group</label>
                    <div class=" form-group col-sm">
                        <select id="drpBOGROUP_ID" name="BOGROUP_ID"></select>
                    </div>
                </div>
                <div class=" form-row">
                    <label for="txtBorrowerID" class="col-sm-3 col-form-label">Borrower ID</label>
                    <div class="form-group col-sm">
                        <input type="text" class="form-control" id="txtBorrowerID" name="BorrowerID" maxlength="200"
                        ...
                        <div class="row">
                            <div class="form-group col-sm-5 ">
                                <input type="text" class="form-control" id="txtLastName" name="LastName"
                                    maxlength="200" placeholder="Last Name" autocomplete="off">
                            </div>
                            <div class=" form-group col-sm-7 ">
                                <input type="text" class="form-control" id="txtFirstName" name="FirstName"
                                    maxlength="200" placeholder="First Name" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class=" form-row">
                    ...
                    <div class="form-group col-sm">
                        <input type="email" class="form-control" id="txtEmail" name="Email" maxlength="200"
    ...
    $(document).ready(function() {
        ...
        var validator = $('#frm').validate({
            ...
            messages: {
                ...
                BorrowerID: {
                    required: 'Please enter Borrower ID.',
                    remote: 'ID is existed,please enter another name'
                },
        ...
        $('#editModal').modal({
            ...
            if (infoData != null) {
                ...
                $('#txtBorrowerID').val(infoData.BorrowerID).trigger('change');
